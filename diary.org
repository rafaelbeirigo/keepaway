...
* 
Aprendizado 'From Scratch' utilizando a estrutura do PRQL.

Não foram carregadas políticas para reuso para nenhum keeper.

Isso forçaria o sistema a realizar o aprendizado com o Sarsa(lambda)
da forma original, mas utilizando o esquema de epsilon-greedy do
Fernández.
